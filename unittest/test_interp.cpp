...
bool test_shift_weights(T_int shift, float64 ww[Order + 2]);

template <int Order, typename T_array>
bool test_interp2d_scalar(T_array eb, int iz0, int iy0, int ix0, float64 delt, float64 epsilon);
...
TEST_CASE("Interpolation shift weights")
{
  ...
  SECTION("First-order")
  {
    ...
    // scalar
    REQUIRE(test_shift_weights<1>(0, ww) == true);
    REQUIRE(test_shift_weights<1>(1, ww) == true);

    // vector
    REQUIRE(test_shift_weights<1>(shift_simd, ww) == true);
  }
  SECTION("Second-order")
  {
    ...
    // scalar
    REQUIRE(test_shift_weights<2>(0, ww) == true);
    REQUIRE(test_shift_weights<2>(1, ww) == true);

    // vector
    REQUIRE(test_shift_weights<2>(shift_simd, ww) == true);
  }
  SECTION("Third-order")
  {
    const int size     = 5;
    ...
    // scalar
    REQUIRE(test_shift_weights<3>(0, ww) == true);
    REQUIRE(test_shift_weights<3>(1, ww) == true);

    // vector
    REQUIRE(test_shift_weights<3>(shift_simd, ww) == true);
  }
  SECTION("Fourth-order")
  {
    ...
    // scalar
    REQUIRE(test_shift_weights<4>(0, ww) == true);
    REQUIRE(test_shift_weights<4>(1, ww) == true);

    // vector
    REQUIRE(test_shift_weights<4>(shift_simd, ww) == true);
  }
}
...
TEST_CASE("Interpolation 2D")
{
  ...
  SECTION("First-order interpolation : scalar")
  {
    ...
    REQUIRE(test_interp2d_scalar<1>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_scalar<1>(eb, 0, 2, 8, delt, eps) == true);
  }
  SECTION("First-order interpolation : xsimd")
  {
    // scalar indices
    REQUIRE(test_interp2d_xsimd<1>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_xsimd<1>(eb, 0, 2, 8, delt, eps) == true);

    // vector indices
    simd_i64 iy0 = xsimd::load_unaligned(iy0_data.data());
    simd_i64 ix0 = xsimd::load_unaligned(ix0_data.data());
    REQUIRE(test_interp2d_xsimd<1>(eb, 0, iy0, ix0, delt, eps) == true);
  }
  //
  // second order
  //
  ...
  {
    REQUIRE(test_interp2d_scalar<2>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_scalar<2>(eb, 0, 2, 8, delt, eps) == true);
  }
  SECTION("Second-order interpolation : xsimd")
  {
    // scalar indices
    REQUIRE(test_interp2d_xsimd<2>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_xsimd<2>(eb, 0, 2, 8, delt, eps) == true);

    // vector indices
    simd_i64 iy0 = xsimd::load_unaligned(iy0_data.data());
    simd_i64 ix0 = xsimd::load_unaligned(ix0_data.data());
    REQUIRE(test_interp2d_xsimd<2>(eb, 0, iy0, ix0, delt, eps) == true);
  }
  //
  // third order
  //
  ...
  {
    REQUIRE(test_interp2d_scalar<3>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_scalar<3>(eb, 0, 2, 8, delt, eps) == true);
  }
  SECTION("Third-order interpolation : xsimd")
  {
    // scalar indices
    REQUIRE(test_interp2d_xsimd<3>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_xsimd<3>(eb, 0, 2, 8, delt, eps) == true);

    // vector indices
    simd_i64 iy0 = xsimd::load_unaligned(iy0_data.data());
    simd_i64 ix0 = xsimd::load_unaligned(ix0_data.data());
    REQUIRE(test_interp2d_xsimd<3>(eb, 0, iy0, ix0, delt, eps) == true);
  }
  //
  // fourth order
  //
  ...
  {
    REQUIRE(test_interp2d_scalar<4>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_scalar<4>(eb, 0, 2, 8, delt, eps) == true);
  }
  SECTION("Fourth-order interpolation : xsimd")
  {
    // scalar indices
    REQUIRE(test_interp2d_xsimd<4>(eb, 0, 2, 2, delt, eps) == true);
    REQUIRE(test_interp2d_xsimd<4>(eb, 0, 2, 8, delt, eps) == true);

    // vector indices
    simd_i64 iy0 = xsimd::load_unaligned(iy0_data.data());
    simd_i64 ix0 = xsimd::load_unaligned(ix0_data.data());
    REQUIRE(test_interp2d_xsimd<4>(eb, 0, iy0, ix0, delt, eps) == true);
  }
}
