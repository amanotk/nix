...
TEST_CASE("CollectiveRead1")
{
  ...
  // read and check results
  {
    ...
    jsonio::open_file(filename, &fh, &disp, "r");
    jsonio::read_collective(&fh, &disp, &in_i32a[p], s, sizeof(int32_t));
    jsonio::read_collective(&fh, &disp, &in_i64a[p], s, sizeof(int64_t));
    jsonio::read_collective(&fh, &disp, &in_f32a[p], s, sizeof(float32));
    jsonio::read_collective(&fh, &disp, &in_f64a[p], s, sizeof(float64));
    jsonio::close_file(&fh);
...
TEST_CASE("CollectiveWrite1")
{
  ...
  // write to file
  {
    ...
    jsonio::open_file(filename, &fh, &disp, "w");
    jsonio::write_collective(&fh, &disp, &i32a[p], s, sizeof(int32_t));
    jsonio::write_collective(&fh, &disp, &i64a[p], s, sizeof(int64_t));
    jsonio::write_collective(&fh, &disp, &f32a[p], s, sizeof(float32));
    jsonio::write_collective(&fh, &disp, &f64a[p], s, sizeof(float64));
    jsonio::close_file(&fh);
  }
...
TEST_CASE("CollectiveRead2")
{
  ...
  // read and check results
  {
    ...
    jsonio::open_file(filename, &fh, &disp, "r");
    jsonio::read_collective(&fh, &disp, in_i32a.data(), nd, gs, ls, os,
                            sizeof(int32_t));
    jsonio::read_collective(&fh, &disp, in_i64a.data(), nd, gs, ls, os,
                            sizeof(int64_t));
    jsonio::read_collective(&fh, &disp, in_f32a.data(), nd, gs, ls, os,
                            sizeof(float32));
    jsonio::read_collective(&fh, &disp, in_f64a.data(), nd, gs, ls, os,
                            sizeof(float64));
    jsonio::close_file(&fh);
...
TEST_CASE("CollectiveWrite2")
{
  ...
  // write to file
  {
    ...
    jsonio::open_file(filename, &fh, &disp, "w");
    jsonio::write_collective(&fh, &disp, local_i32a.data(), nd, gs, ls, os,
                             sizeof(int32_t));
    jsonio::write_collective(&fh, &disp, local_i64a.data(), nd, gs, ls, os,
                             sizeof(int64_t));
    jsonio::write_collective(&fh, &disp, local_f32a.data(), nd, gs, ls, os,
                             sizeof(float32));
    jsonio::write_collective(&fh, &disp, local_f64a.data(), nd, gs, ls, os,
                             sizeof(float64));
    jsonio::close_file(&fh);
  }
